...
export default function Navbar() {
    return ( <
        ...
        /ul> <
        /div> <
        div > < a href = "https://pancakeswap.finance/swap?outputCurrency=0x39AA9A863c16917959f040A77c3747Af27e8c5A6"
        target = "_blank"
        rel = "noopener noreferrer"
        className = 'cursor-pointer flex items-center justify-center border border-white bg-[#264A20] text-white md:p-4 p-3 rounded-xl drop-shadow-xl hover:bg-[#4F9843] transition-all duration-300 ease-in-out hover:border hover:border-black hover:text-black' > $pepes < svg xmlns = "http://www.w3.org/2000/svg "
        width = "16"
        height = "16"
        fill = "currentColor"
