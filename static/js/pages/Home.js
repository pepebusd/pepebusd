...
export default function Home() {
    return ( <
        ...
        <
        p className = 'md:text-[3rem] sm:text-[2rem] text-[22px] mb-10  font-bold px-4 py-2 text-center rounded-xl border-2 shadow-lg hover:text-white hover:bg-[#4C9540] text-[#264A20]  bg-white border-[#264A20]  hover:opacity-600 transition-all duration-300 ease-in-out' > Welcome to Pepe Smoky < /p> <
        /div> <
        ...
        <
        p className = 'mb-10 border p-4 rounded-xl w-auto font-medium' > < span className = 'text-[25px] font-bold' > " 1.1 billion Smokers in the world & for the love of Smokers we launched a community based token Pepes Smoky" < br / > < /span> <span className='text-[20px]'>Pepe smoky is a community-based meme token, people smoke because it's a way they've learned to cope with<strong> STRESS</strong > , We are here to help you Reduce < strong > STRESS < /strong>with<strong> MEMEs</strong > < br / > We created a meme out of it to keep you happy and < strong > STRESS FREE < /strong><br / > We WELCOME < strong > Smokers < /strong> to join our Community.</span > < /p> <
        /div> <
        /div> <
        div className = "flex items-center justify-center lg:flex-row flex-col lg:space-x-8" >
        <
        a href = "https://t.me/pepesmoky"
        target = "_blank"
        ...
        a href = "https://twitter.com/SmokyPepe"
        target = "_blank"
        rel = "noopener noreferrer"
        ...
        <
        span className = 'text-[2rem]' > About Pepe Smoky < /span> <
        hr className = "border border-white md:w-[9rem] w-[3rem]" / >
        <
        /div> <
        div className = 'flex items-center justify-center' >
        <
        p className = 'flex text-[22px] text-center mx-auto font-bold' > $PEPES is Deflationary token < /p> <
        /div> <
        ...
        <
        a href = "https://pancakeswap.finance/swap?outputCurrency=0x39AA9A863c16917959f040A77c3747Af27e8c5A6"
        target = "_blank"
        rel = "noopener noreferrer"
        ...
        a href = "https://www.dextools.io/app/en/bnb/pair-explorer/0x91273d5b885c0ebd68a7a984e1c33e2b1da9805a"
        target = "_blank"
        rel = "noopener noreferrer"
        className = 'flex items-center justify-center cursor-pointer mb-5 text-center text-[#264A20] border-2  md:p-4 p-3 px-8 rounded-xl shadow-lg hover:text-white hover:bg-[#4C9540] bg-white border-[#264A20] transition-all duration-300 ease-in-out' > $pepes Chart < /a> <
        /div> <
        ...
        <
        /div> <
        p className = 'md:text-5xl text-3xl pb-10 font-Leckerli font-bold text-center' > Token Supply : 100, 000, 000, 000 < /p> <
        ...
        p className = 'text-center text-[16px]' > 1 % Dev tax on every transaction to help the devs of $Pepes smoky < /p> <
        /div> <
        /div> <
        div className = "md:col-span-1 col-span-3 " >
        <
        ...
        li > Get $PEPES Trending on twitter with our memetic power < /li> <
        li > 1, 000 + Holders < /li> <
        li > Community Partnerships $Pepes Times digital newsletter < /li> <
        /ol> <
        /div> <
        /div> <
        /div> <
        ...
        p className = 'text-center mt-[1rem] px-4 max-w-md text-[16px]' > Create a MetaMask Wallet using either a desktop computer or an iOS / Android mobile device.That will allow you to buy, sell, send, and receive $pepes < /p> <
        /div> <
        /div> <
        div className = "col-span-1" >
        <
        ...
        for $pepes < /h2> <
        p className = 'text-center mt-[1rem] px-4 max-w-md text-[16px]' > You can start swapping as soon as you have BNB available!Press‘ Select a currency’ and enter the $pepes token address : < a href = "https://pancakeswap.finance/swap?outputCurrency=0x39AA9A863c16917959f040A77c3747Af27e8c5A6"
        target = "_blank"
        rel = "noopener noreferrer"
        ...
        <
        /div> <
        p className = 'flex text-[22px]' > Pepe Smoky is a meme coin with no intrinsic value or expectation of financial
        return .There is no roadmap, no fake promises of providing a utility.The coin is made
        for the smoker community only, the community will be running it as far as they want it and
